...
/**
 * класс Coins_5 for and realisation geting and keeping coins.
 *
 * @author Sirotkin.
 *
 */
public class Coins_5 implements ICoins {
    ...
    private int differenceCashBalance = maxCash - cashBalance;
         ...
         *
         */
        public Coins_5(int balanceMonets, int change) {
    ...
    public void giveChange() {
        ...
        public void  info() {    System.out.print("Your balanceMonets is" + balanceMonets + "5 coins" + ", cashBalance" + cashBalance); }
