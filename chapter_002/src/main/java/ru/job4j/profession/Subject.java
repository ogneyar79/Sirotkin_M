...
public class Subject {
    ...
    Subject[] subLissts = new Subject[quantity];
      // ? do I need to implement here new instance?
    Subject.subLissts[0]= math_1;
    ...
    public String getCalledSubj(String name) {
        ...
        for (Subject SuLisst : SuLissts) {
            if (this.name == name) {
                 answered=this.calledSubject;

                             }
else {
                answered="Преподователь"+" "+ name + " " + "Не ведет ни один предмет в нашей школе ";
